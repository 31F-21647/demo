...
export default class App {
    ...
    constructor(data){
        ...
        let horaire = new Horaire(document.querySelector('.horaire'), false, data);  
        this.#aSequence.push(horaire);  // Ajouter à la séquence
        ...
        /*document.querySelectorAll("[data-panneau]").forEach((element)=> {
            element.addEventListener("click", (e)=>{
                ...
                this.indexPanneau = e.target.dataset.panneau;
            });
        })*/
    }
    ...
    changerPage(){
        ...
        if(this.#aSequence[this.indexPanneau].estValide()){
            let data = [];
            // Si le composant a une méthode getData
            if( this.#aSequence[this.indexPanneau].getData){
                // Récupère les données
                data = this.#aSequence[this.indexPanneau].getData();
            }
            ...
            // Si le composant a une méthode setData
            if(this.#aSequence[this.indexPanneau].setData){
                // Passer les données (de getData du dernier panneau) au prochain composant
                this.#aSequence[this.indexPanneau].setData(data);
            }
