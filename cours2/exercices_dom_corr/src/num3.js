...
window.addEventListener("load", ()=>{
    ...
    document.querySelector("form").addEventListener("submit", function(e){
        ...
        const nouvItem =    `<div class="item animApparaitre">
        ...
        document.querySelector(".animApparaitre").addEventListener("animationend", function(e){
            e.target.classList.remove("animApparaitre");
        }, {once:true});
