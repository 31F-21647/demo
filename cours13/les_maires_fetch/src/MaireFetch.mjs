...
export default class MaireFetch {
    ...
    constructor(){
      ...
      * @param {function} params.callback - La fonction de rappel, elle attend un paramètre, les données
      * @returns {UnMaire[]} - Tableau des résultats;
      * @static
     */
    async rechercheMaires(params){
        let data = await fetch("https://jmartel.webdev.cmaisonneuve.qc.ca/wsmaires/maires/recherche?type=date&valeur=2012")
